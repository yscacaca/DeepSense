...
def deepSense(inputs, train, reuse=False, name='deepSense'):
	with tf.variable_scope(name, reuse=reuse) as scope:
		...
		acc_conv_out = tf.reshape(acc_conv3, [acc_conv3_shape[0], acc_conv3_shape[1], acc_conv3_shape[2], 1, acc_conv3_shape[3]])
		...
		gyro_conv_out = tf.reshape(gyro_conv3, [gyro_conv3_shape[0], gyro_conv3_shape[1], gyro_conv3_shape[2], 1, gyro_conv3_shape[3]])	


		sensor_conv_in = tf.concat([acc_conv_out, gyro_conv_out], 3)
		...
		sensor_conv_in = tf.reshape(sensor_conv_in, [gyro_conv3_shape[0], gyro_conv3_shape[1], gyro_conv3_shape[2]*2, gyro_conv3_shape[3]])
...
LOAD_DIR = 'deepSense_noConv3_model_saver'
LOAD_FILE = 'tfdroid_deepSenseNoConv3D.ckpt'
SAVE_DIR = 'deepSense_noConv3D_saver'
